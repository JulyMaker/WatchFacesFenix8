...
class WFDelegate extends WatchUi.WatchFaceDelegate  {
    ...
    var zones = {
     ...
     var zones240 = {
        :field1 => { :x=>35,  :y=>57, :width=>32, :height=>47 },
        :field2 => { :x=>83,  :y=>20, :width=>75, :height=>20 },
        :field3 => { :x=>175, :y=>60, :width=>32, :height=>47 },
        :field4 => { :x=>177, :y=>140,:width=>32, :height=>48 },
        :field5 => { :x=>35,  :y=>140,:width=>32, :height=>48 },
        :dateFi => { :x=>80,  :y=>110,:width=>90, :height=>21 },
        :birthday=>{ :x=>45,  :y=>35 ,:width=>25, :height=>21 }
    };
